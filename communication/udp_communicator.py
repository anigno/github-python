...
class UdpCommunicator:
    ...
    UDP_DEFAULT_RECEIVE_BUFFER_SIZE = 10 * 1024
    ...
    def _receiver_thread_start(self):
        try:
            while True:
                ...
                self._data_received_handling(received_data_bytes, sender_endpoint_tuple)
        except OSError as ex:
            print(ex)

    def _data_received_handling(self, received_data_bytes, sender_endpoint_tuple):
